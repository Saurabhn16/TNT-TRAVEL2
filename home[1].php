...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(images/final.jpg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(images/final2.jpg) no-repeat">
            <div class="content">
               <span>explore, discover, travel</span>
         ...
         <div class="swiper-slide slide" style="background:url(images/final3.jpg) no-repeat">
            <div class="content">
               <span>explore, discover, travel</span>
